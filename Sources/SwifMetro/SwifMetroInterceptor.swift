...
@_silgen_name("NSLog")
func NSLog(_ format: NSString, _ args: CVarArg...)

@_silgen_name("printf")
func printf(_ format: UnsafePointer<Int8>!, _ args: CVarArg...) -> Int32

@_silgen_name("fprintf")
func fprintf(_ stream: UnsafeMutablePointer<FILE>!, _ format: UnsafePointer<Int8>!, _ args: CVarArg...) -> Int32
